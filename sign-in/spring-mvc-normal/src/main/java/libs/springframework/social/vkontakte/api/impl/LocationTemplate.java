...
import libs.springframework.social.vkontakte.api.City;
import libs.springframework.social.vkontakte.api.CityList;
import libs.springframework.social.vkontakte.api.ILocationOperations;
...
public class LocationTemplate extends AbstractVKontakteOperations implements ILocationOperations {
    ...
    public List<City> getCitiesById(Collection<Integer> ids) {
        ...
        URI uri = makeOperationURL("database.getCitiesById", props, ApiVersion.VERSION_5_27);
