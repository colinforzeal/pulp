...
import libs.springframework.social.vkontakte.api.*;
import libs.springframework.social.vkontakte.api.attachment.*;
import libs.springframework.social.vkontakte.api.attachment.Audio;
import libs.springframework.social.vkontakte.api.impl.json.attachment.*;
...
public class VKontakteModule extends SimpleModule {
    ...
    public void setupModule(SetupContext context) {
        ...
        context.setMixInAnnotations(libs.springframework.social.vkontakte.api.Error.class, ErrorMixin.class);
        ...
        context.setMixInAnnotations(libs.springframework.social.vkontakte.api.Audio.class, AudioAttachmentMixin.class);
